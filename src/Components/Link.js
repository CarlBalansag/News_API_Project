...
return (
    ...
    <div className="mx-2 max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:border-gray-700">
            <img className="rounded-t-lg w-100" src={props.image} alt={props.title} />
        <div className="p-5">
